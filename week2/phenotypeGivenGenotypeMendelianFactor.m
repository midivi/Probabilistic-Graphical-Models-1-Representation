...
% [1,1] trait given AA 1
% [2,1] notrait given AA 0
% [1,2] trait given Aa 1
% [1,2] notrait given Aa 0
% [1,3] trait given aa 0
% [1,3] notrait given aa 1
%  easier to just do manually
if isDominant==1
